      ...
      <div class="table-responsive cart_info"> 
              ...
              ?>
                         ...
                         <!-- <td></td> -->
                          ...
                          <td> <?php echo  $result->PRODISPRICE ?> &#8376</td>
                          <td> <output><?php echo $_SESSION['gcCart'][$i]['price']?></output> &#8376</td>
                        </tr>
              <?php
              ...
              ?>
                ...
                <div class="  pull-right">
                  <p align="right">
                  <div > Total Price :    <span id="sum">0.00</span> &#8376</div>
                   <div > Delivery Fee : <span id="fee">0.00</span> &#8376</div>
                   <div> Overall Price : <span id="overall"><?php echo $tot ;?></span> &#8376</div>
