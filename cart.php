...
?>
             ...
             ';
                                  ...
                                  <td>
                                    ...
                                    <?php echo  $result->PRODISPRICE ; ?> &#8376
                                  </td>
                                  <td class="input-group custom-search-form" >
                                     ...
                                     <td><output id="Osubtot<?php echo $result->PROID ?>"><?php echo   $_SESSION['gcCart'][$i]['price'] ; ?> &#8376 </output></td>
                                </tr>
                        ...
                        <h3 align="right"> Total  <span id="sum">0</span> &#8376</h3> 
    </div>
  </div>  
