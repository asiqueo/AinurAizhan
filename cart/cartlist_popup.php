                ...
                <div class="panel panel-default panel-shadow">
                    ...
                    <div class="table-responsive">
                         ...
                         <body onload=" totalprice(); ">
                              ...
                              <form id="form" action="cart/controller.php?action=edit" method="POST"  
                                  ...
                                  <div class="column4">                                  
                                    ...
                                    <!-- <div style="float: right; width:100px"></div> -->
                                     <div style="float: left; width:50px">&nbsp;&nbsp;<span id="price1"><?php echo $result->PRICE; ?></span> &#8376</div>
                                     <div  id="test" style="float: right; width:50px"><output name="TOTAL" for="QTY price"> &#8376</output></div>                                     
                                  </div>
                              </form> 
                            ...
                            <tr >  
                            <td>                               
                             <div class="culomn4"><div style="float: right;"><h1> Total Price :<span id="sum">0</span> &#8376</h1></div></div>
                            </td>                        
