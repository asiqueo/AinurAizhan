  ...
  <?php check_message(); ?>
      <div class="">
        <div class="panel panel-default">
          ...
          <div>Every products has a mininum price of 50.00 &#8376 each to be able to order.</div>
      <div class="table-responsive">
       <div  class="fixnmix_scroll_carttwo" >
         ...
         <tbody > 
            ...
            ?>
                      <tr>
                        ...
                        <td> <?php echo number_format($result->PRICE,2) ?>v &#8376</td>
                        ...
                        <td> <output id="Osubtot<?php echo $result->PRODUCTID ?>"> &#8376<?php echo   $_SESSION['fixnmix_cart'][$i]['price'] ; ?></output>
        ...
        ?>
                  ...
                  <table  >
                  <tfoot >
                     <strong><h1 align="right">Total Price : <span style="margin-right:3%"  id="sum">0.00</span> &#8376</h1></strong></td>
