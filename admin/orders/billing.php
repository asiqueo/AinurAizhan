            ...
            <tr>
              ...
              ?>
                         ...
                         <td></td>
                          ...
                          <td><?php echo  $result->PRICE ?> &#8376 </td>
                          <td><output><?php echo $_SESSION['fixnmix_cart'][$i]['price']?></output> &#8376 </td>
                        </tr>
              <?php
                        }
              ...
              <!--   <div class="col-md-6 pull-left">
                ...
                <div class="col-md-4 pull-right">
                  <!-- <div>Total Price : <?php echo number_format($tot,2);?> &#8376 </div> -->
                  <!-- <div>Delivery Fee :<?php echo number_format($price,2); ?> &#8376 </div> -->
                  <div>Overall Price :<?php echo number_format($cur->TOTALPRICE,2); ?> &#8376 </div>
                </div>
              </div>
