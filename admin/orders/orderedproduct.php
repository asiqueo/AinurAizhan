	...
	"post">
				...
				<?php
				  ...
				  $query = "SELECT * 
						...
						echo '<tr>';  
				  		...
				  		echo '<td>'.number_format($result->PROPRICE,2).' &#8376  </td>';
				  		echo '<td align="center" >'. $result->ORDEREDQTY.'</td>';
				  		?>
				  		 <td><output><?php echo number_format($result->ORDEREDPRICE,2); ?></output> &#8376 </td> 
				  		<?php
       ...
       <div class="row">
		  	...
		  	<div class="col-md-6 pull-right">
		  		<p align="right">Total Price : <?php echo number_format($subtot,2);?> &#8376 </p>
		  		<p align="right">Delivery Fee : <?php echo number_format($cur->DELFEE,2); ?> &#8376 </p>
		  		<p align="right">Overall Price : <?php echo number_format($cur->PAYMENT,2); ?> &#8376 </p>
		  	</div>
		  </div> 
		</div>   
